...
CREATE TABLE `__new_article` (
	...
	`published_at` integer DEFAULT 1767656174029 NOT NULL,
	`created_at` integer DEFAULT 1767656174029 NOT NULL,
	`updated_at` integer DEFAULT 1767656174029 NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_subscriber`("id", "email", "created_at", "updated_at", "active") SELECT "id", "email", "created_at", "updated_at", "active" FROM `subscriber`;--> statement-breakpoint
